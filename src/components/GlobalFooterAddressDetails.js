        ...
        return (
            <div className='col-lg-3 col-sm-6'>
                ...
                <div className='location_text'>
                    <ul>
                        <li> <a href="#"> <i className="fa fa-map-marker" aria-hidden="true"></i>
                            <span className="padding_left_10">{address}</span>
                        </a> </li>
                        <li> <a href="#"> <i className="fa fa-phone" aria-hidden="true"></i> <span className="padding_left_10">Call: {PhoneNumber}</span> </a> </li>
