                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-12 col-md-4">
                                <div className="box_main active">
                                    <div className="house_icon">
                                        <img src="images/Service/speed-xerox-porur-chennai-photocopying-centres-service.png" alt="Speed Xerox" className="image_1" />
                                        <img src="images/Service/speed-xerox-porur-chennai-photocopying-centres-service.png" alt="Speed Xerox" className="image_2" />
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12 col-md-4">
                                <div className="box_main">
                                    <div className="house_icon">
                                        <img src="images/Service/dtp.png" alt="Speed Xerox" className="image_1" />
                                        <img src="images/Service/dtp.png" alt="Speed Xerox" className="image_2" />
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12 col-md-4">
                                <div className="box_main">
                                    <div className="house_icon">
                                        <img src="images/Service/BrochurePrinting.png" alt="Speed Xerox" className="image_1" />
                                        <img src="images/Service/BrochurePrinting.png" alt="Speed Xerox" className="image_2" />
                                    </div>
